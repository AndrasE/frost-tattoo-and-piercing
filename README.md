...
The app is styled with styled-components, animated using React Scroll, Framer Motion, React-Swipable and Lottie, and automatically detects the user's browser language and preferred theme, loading with those settings by default. Users can adjust these preferences, which are saved for future visits.  
<br />
