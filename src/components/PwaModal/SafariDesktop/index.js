...
const SafariDesktop = () => {
  return (
    <>
      <Divider />
      <Description>
        This site has app functionality. Add it to your Dock for extensive
        experience and easy access.
      </Description>
      <Divider />
      <InstallStepsWrapper>
        <InstallStep>
          <ShareIcon />
          Press the 'Share' button on in the address bar.
        </InstallStep>
        <InstallStep>
          <AddDocSvg viewBox="0 0 23.389 17.979" width="25" height="25">
            <g fill="currentColor">
          ...
          In the dropdown menu, choose 'Add to Dock'.
        </InstallStep>
      </InstallStepsWrapper>
    </>
  );
